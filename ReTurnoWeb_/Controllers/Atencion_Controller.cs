...
namespace ReTurnoWeb_.Controllers
{
    class Atencion_Controller
    {
        public static bool crearAtencion(Atencion atencion)
        {
            ...
            cmd.Parameters.AddWithValue("@suc_serv", atencion.SucursalServicio.Id);
            cmd.Parameters.AddWithValue("@hora_apertura", atencion.HoraApertura);
            cmd.Parameters.AddWithValue("@hora_cierre", atencion.HoraCierre);
            cmd.Parameters.AddWithValue("@personal", atencion.PersonalServicio);
